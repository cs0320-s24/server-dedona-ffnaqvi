...
public class TestCensusAPIUtilities {
    ...
    public void testCensusDeserialize() throws IOException {
        String lauderdaleCounty = "[[\"NAME\",\"S2802_C03_022E\",\"state\",\"county\"],\n" +
        ...
        Assert.assertEquals("[Lauderdale County, Alabama has the estimated percent broadband internet subscription of: 77.8%]", censusList.get(0).toString());
    }
